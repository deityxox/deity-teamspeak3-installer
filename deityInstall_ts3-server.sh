#!/bin/bash
# Name: deityInstall_ts3-server.sh
# Version: 1
# Created On: 5/7/2025
# Updated On: 5/7/2025
# Created By: deity
# Description: Automagically installs the Linux TeamSpeak 3 Server
# Tested on: ubuntu 24.04 / x64 / VPS / 2 Cores / 2GB RAM / 20 GB SSD
...
# official download urls - updated on: 5/7/2025
